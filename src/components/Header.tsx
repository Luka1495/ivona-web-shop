    ...
    <header className="sticky top-0 z-50 border-b border-[#e9dfd1] bg-[#fcfbf8]/95 backdrop-blur-sm">
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="text-2xl font-semibold tracking-[0.2em] text-[#3f342d]">
            IVONA
          </Link>

          <div className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-sm font-medium text-[#6f6259] transition hover:text-[#3f342d]">
              Naslovna
            </Link>
            <Link href="/shop" className="text-sm font-medium text-[#6f6259] transition hover:text-[#3f342d]">
              Shop
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="mt-4 space-y-2 border-t border-[#eee4d9] pt-4 md:hidden">
            <Link href="/" className="block rounded-xl px-3 py-2 text-sm font-medium text-[#6f6259] hover:bg-[#f7efe7]" onClick={() => setIsMenuOpen(false)}>
              Naslovna
            </Link>
            <Link href="/shop" className="block rounded-xl px-3 py-2 text-sm font-medium text-[#6f6259] hover:bg-[#f7efe7]" onClick={() => setIsMenuOpen(false)}>
              Shop
            </Link>
          </div>
        )}
